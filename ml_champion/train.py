...
for model_name in model_names:
    ...
    with mlflow.start_run(run_name=model_name):
        ...
        plt.savefig(f"mlflow/train_artifacts/roc_curve_{model_name}.png")
        mlflow.log_artifact(f"mlflow/train_artifacts/roc_curve_{model_name}.png")
        ...
        feature_importance.to_markdown(f"mlflow/train_artifacts/feature_importance_{model_name}.md")
        
        # Registra o arquivo como artefato no MLflow para versionamento
        mlflow.log_artifact(f"mlflow/train_artifacts/feature_importance_{model_name}.md")
...
model_df.to_pickle("ml_champion/models/model.pkl")